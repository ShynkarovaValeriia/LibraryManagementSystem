...
namespace LibraryManagementSystem
{
    public partial class Books : Form
    {
        public Books(string username)
        {
            ...
            this.FormClosing += Books_FormClosing;
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                // Перевірка унікальності Номера книги
                bool unique = true;
                foreach (DataGridViewRow row in gridViewBooks.Rows)
                {
                ...
                {
                    MessageBox.Show("Номер книги має бути унікальним значенням", "Помилка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void btnSaveFile_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Якщо таблиця "Книги" вже існує, отримуємо посилання на неї
                    dt = ds.Tables["Books"];
                ...
                {
                    // Якщо таблиця "Книги" не існує, створюємо нову таблицю
                    dt = new DataTable();
                    dt.TableName = "Books";
                ...
                // Записуємо дані з DataGridView до таблиці "Книги"
        ...
        private void Books_FormClosing(object sender, EventArgs e)
        {
            string folderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "LibraryManagementSystem");
            string filePath = Path.Combine(folderPath, "Books.xml");
            ...
            try
            {
                ...
                DataTable dt;
                // Перевіряємо, чи таблиця "Книги" вже існує
                if (ds.Tables.Contains("Books"))
                {
