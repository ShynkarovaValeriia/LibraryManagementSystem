namespace LibraryManagementSystem
{
    partial class Login
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.eyeOpen.TabIndex = 12;
            this.eyeOpen.TabStop = false;
            this.toolTip1.SetToolTip(this.eyeOpen, "Натисніть, щоб відобразити пароль");
            ...
            this.eyeClose.TabIndex = 13;
            this.eyeClose.TabStop = false;
            this.toolTip2.SetToolTip(this.eyeClose, "Натисніть, щоб приховати пароль");
            this.eyeClose.Visible = false;
